...
export default function TemplateClient() {
  ...
  useEffect(() => {
    ...
    const ensureTargets = () => {
      ...
      resumeStep = form.closest<HTMLElement>(".resume-step") ?? (form.parentElement as HTMLElement | null);
    };
  ...
  return (
    <>
      <style>{`
        ...
        .r5-enhanced-form .button.button--primary,
        .r5-enhanced-step button[disabled][type="submit"] {
